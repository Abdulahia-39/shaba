// const homeAboutImage = '/assets/homeaboutpic.jpg';
// import homeAboutImage from '/assets/shabalogo.png';
        ...
        <section className="flex w-full flex-col lg:flex-row mb-15">
            ...
            <div className="flex-1 flex flex-col justify-center items-start gap-6 p-10">
                ...
                <div className="mt-4 p-4 flex flex-col justify-center items-end lg:w-full sm:w-[400px] md:w-[550px] w-[350] mx-auto">
                    <Link href="/about"><p className="bg-green-800 text-white w-35 h-12 rounded-lg text-medium font-medium flex justify-center items-center">Learn More</p></Link>
                </div>
            </div>
        </section>
    );
