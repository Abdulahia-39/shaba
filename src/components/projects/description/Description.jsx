    ...
    <section className="w-5/6 mx-auto mt-35">
        <div className="flex flex-col md:flex-row items-center gap-10 mb-20">
            ...
            <div className="flex-5 flex justify-center">
                <div className="h-50 w-60 sm:h-90 sm:w-100 md:h-70 md:w-60 lg:h-100 lg:w-110 bg-cover bg-center" style={{ backgroundImage: `url(${image})` }}></div>
            </div>           
        </div>
        <div className="flex flex-col md:flex-row items-center gap-10 mb-20">
            <div className="flex-1 md:h-80">
            ...
            <div className="flex-5 flex justify-center">
                <div className="h-50 w-60 sm:h-90 sm:w-100 md:h-70 md:w-60 lg:h-100 lg:w-110 bg-cover bg-center" style={{ backgroundImage: `url(${image2})` }}></div>
            </div>           
        </div>
    </section>
  );
