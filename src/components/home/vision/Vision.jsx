                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-10 mx-auto w-full items-center justify-items-center mt-15">
                    <div className="h-100 px-2 shadow-2xl max-w-70 overflow-auto">
                        <div className="flex justify-center my-8">
                            <i class="fa-solid fa-check text-green-300 text-4xl"></i>
                        </div>
                        <div className="px-5">
                    ...
                    <div className="h-100 px-2 shadow-2xl max-w-70 overflow-auto">
                        <div className="flex justify-center my-8">
                            <i class="fa-solid fa-comment text-green-300 text-4xl"></i>
                        </div>
                        <div className="px-5">
                    ...
                    <div className="h-100 px-2 shadow-2xl max-w-70 overflow-auto">
                        <div className="flex justify-center my-8">
                            <i class="fa-solid fa-flag text-green-300 text-4xl"></i>
                        </div>
                        <div className="px-5">
                    ...
                    <div className="h-100 px-2 shadow-2xl max-w-70 overflow-auto">
                        <div className="flex justify-center my-8">
                            <i class="fa-solid fa-tree text-green-300 text-4xl"></i>
                        </div>
                        <div className="px-5">
